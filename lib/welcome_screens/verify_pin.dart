      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(left: 86.w, right: 111.w),
            ...
            SizedBox(height: 10.h,),
            Padding(
              padding: EdgeInsets.only(left: 143.w, right: 164.w),
              child: Text('Retype pin',
                style: TextStyle(fontSize: 20.sp, fontFamily: 'DM Sans',
                    fontWeight: FontWeight.w500, color: Utils.yellowTheme
                ),
              ),
            ),
            ...
            Padding(padding: EdgeInsets.symmetric(horizontal: 43.5.w),
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: (){
                    Get.offAll(()=> const AccountSuccessful());
                  },
