...
class SplashB extends StatefulWidget {
  const SplashB({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        ...
        children: [
          Positioned(
            left: -111.w, top: -106.h,
            child: Image.asset('assets/images/upr.png',
              width: 566.w, height: 1192.h,),
          ),
          Positioned(
            left: 16.w, top: 106.h,
                  ...
                  children: [
                    ...
                    Text('Transfer that is safe',
                      style: TextStyle(
                          ...
                          color: Utils.yellowTheme, fontSize: 18.sp
                      ),),
